/*
source
https://cdn-cms-s.f-static.net/versions/2/js/minimize_scripts.js?v=y82941
*/
   ...
   function generateHTML() {
      ...
      if ($('#websiteHeaderSettings').data('arranged-icons') === true) {
         $('#mainNavMobile .navActions li').each(function () {
            ...
            if ($this.hasClass('website-languages-menu')) {
      ...
      switch (btn) {
         ...
         case 'cart':
            if (settings.isSideMenu) {
               html += '<li class="header-cart-wrapper orderOpenCart header-icon-wrapper' + (settings.btns[btn].isActive ? ' show-static' : '') + ($('#websiteHeaderSettings').data('arranged-icons') === true ? ' arranged-icons' : '') + '" data-has-online-store="' + settings.btns[btn].hasOnlineStore + '"><div class="s-c-w">' + settings.btns[btn].showMenuActionButtons + '</div></li>';
            } else {
               html += '<li class="header-cart-wrapper orderOpenCart' + (settings.btns[btn].isActive ? ' show-static' : '') + ($('#websiteHeaderSettings').data('arranged-icons') === true ? ' arranged-icons' : '') + '" data-has-online-store="' + settings.btns[btn].hasOnlineStore + '">' + settings.btns[btn].showMenuActionButtons + '</li>';
            }
            break;
         case 'phone':
            if (type == 'mobile') {
